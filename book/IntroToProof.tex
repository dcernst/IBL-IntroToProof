...
\clearpage\input{1.2-intro-logic}
\clearpage\input{1.3-negation}
% here, we skip 1 to get back on track (see above)...
\addtocounter{theorem}{1}
\clearpage\input{1.4-quantification}
\clearpage\input{1.5-quantification2}
%\clearpage\input{1.6-quantification3}
\end{chapter}
