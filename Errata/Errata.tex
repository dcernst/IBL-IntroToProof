...
\item Page 18, line 11: Added missing ``of'' and removed extra ``on''. [Luiz Filipe]
...
\item Page 24, line $-13$: Added ``a'' between ``is'' and ``specific''. [Luiz Filipe]
\item Page 29, line 19: Replaced ``to proof that'' with ``to prove that''. [Luiz Filipe]
...
\item Page 38: Technically, what was written for definition of the rational numbers was not in set-builder notation. The definition of $\mathbb{Q}$ is now written in set-builder notation and there is a comment afterwards about how this notation is often abbreviated. [Jason Siefken]
\item Page 39, line $-1$: Removed spurious ``s''. [Luiz Filipe]
...
\item Page 84: Three occurrences of $r<n$ and one occurrence of $r<|n|$ were replaced with $r<d$ and $r<|d|$, respectively. Two of these errors appeared in paragraph below proof of the Division Algorithm and the other two appeared in Problems~6.8 and 6.9. [Ryan Elwood]
...
\item Page 192, Example~9.5: The original example was horribly wrong!  It has been retooled. [Martha Brislen]
\end{itemize}
