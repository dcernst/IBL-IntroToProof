...
Chapter 5 takes a deep dive into the structure of the real numbers by building up the multitude of properties students are familiar with by starting with a collection of axioms. 
