...
- The author might consider adding chapters on other topics that are commonly cov- ered in an introduction to proof course, such as beginning graph theory, a brief introduction to sequences and recurrence relations, and introductory combinatorics and discrete probability.
- Many education majors with math concentrations take an introduction to proof course and might benefit from exercises or problems that ask students to think about a concept from the perspective of a younger learner. For example, I can see having a few questions about negating inequalities, followed up with questions requesting a paragraph explanation to another person why the negation of x < a is x = a or x>a,andhowtonegatea<x<b(forsomevariablex). (Thisiskindofastretch from my area of expertise, but this sort of exercise has been mentioned to me as being beneficial to education majors.) Occasional paragraph explanations might be suitable.
...
- Section 2.1, paragraph 1, last sentence: What discussion is planned? Does the in- structor know what the discussion should include?
...
- p. 14, footnote: “Definition 2.41” should be “Definition 2.39” Chapter 3
...
- #7: The statement breaks rule #4, that it is bad style to start a sentence with a symbol.
#8: Include quantifiers and other logic symbols in the “avoid in formal write-ups” pile.(∀,∃,∨,∧,and ⇐⇒)
- #13: I love this! I call it “bad math.” I’d like to see the backwards example written correctly, as a demonstration.
- #15: Thank you.
- #22: Thank you.
