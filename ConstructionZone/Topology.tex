...
Notice that a set $A$ is \textbf{bounded} if and only if it is a subset of some closed interval.
...
\begin{problem}
Provide several examples of sets that are compact and some that are not compact. Are finite sets compact?
\end{problem}
