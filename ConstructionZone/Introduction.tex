...
\epigraphhead[70pt]{
\epigraph{The mathematician does not study pure mathematics because it is useful; he studies it because he delights in it, and he delights in it because it is beautiful.}{Henri Poincar\'e}}
...
\epigraph{Don't fear failure.  Not failure, but low aim, is the crime. In great attempts it is glorious even to fail.}{Bruce Lee}
...
\epigraph{You may encounter many defeats, but you must not be defeated.}{Maya Angelou}
...
\epigraph{Don't just read it; fight it! Ask your own questions, look for your own examples, discover your own proofs. Is the hypothesis necessary? Is the converse true? What happens in the classical special case? What about the degenerate cases? Where does the proof use the hypothesis?}{Paul Halmos}
...
\epigraph{The best teachers are those who show you where to look, but don't tell you what to see.}{Alexandra K.~Trenfor}
