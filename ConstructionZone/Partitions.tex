...
In other words, two elements are related if and only if they are in the same subset. For example, if you consider the partition of my kids' toys described in Example~\ref{ex:toys}, we say that two toys are related if and only if they are of the same type.
