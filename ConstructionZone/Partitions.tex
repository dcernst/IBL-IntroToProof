...
Let $A=\{a,b,c,d,e,f\}$ and $\Omega=\{\{a\}, \{b,c,d\}, \{b,c,d\}\}$.  Then $\Omega$ is a partition of $A$ since the elements of $\Omega$ are nonempty subsets of $A$, pairwise disjoint, and their union is all of $A$.
\end{example}
