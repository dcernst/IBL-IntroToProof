...
\begin{problem}
For each relation in Problem~\ref{prob:lots of relations}, determine whether the corresponding collection of distinct sets of relatives forms a partition of the given set.
\end{problem}
