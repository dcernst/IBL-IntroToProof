...
%\begin{problem}
%Is the hypothesis that the interval is closed needed in the Intermediate Value Theorem? Justify your answer.
%\end{problem}
...
%\begin{problem}
%Let $f:[0,1]\to \mathbb{R}$ be a function such that $f(0)=-1$, $f(1)=1$, and $f([0,1])=\{-1,1\}$.  Prove that there exists $x\in [0,1]$ such that $f$ is not continuous at $x$.
%\end{problem}
