...
Figure~\ref{fig:continuity} illustrates the definition of continuity. Let's show that this definition of continuity behaves the way we expect from calculus.
