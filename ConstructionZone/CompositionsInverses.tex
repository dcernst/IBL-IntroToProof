...
\node[draw,fit=(A),minimum width=1.5cm,minimum height=2.75cm,gray] {};
\node[draw,fit=(B),minimum width=1.5cm,minimum height=2.75cm,gray] {};
\node[draw,fit=(C),minimum width=1.5cm,minimum height=2.75cm,gray] {};
\node (X) at (0,4.7) {$X$};
\node (Y) at (3,4.7) {$Y$};
\node (Z) at (6,4.7) {$Z$};
