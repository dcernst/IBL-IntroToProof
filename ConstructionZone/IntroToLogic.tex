...
Each of the boxed propositions in the previous definition is called a \textbf{compound proposition}, where $A$ and $B$ are referred to as the \textbf{components} of the compound proposition. We can form complicated compound propositions with several components by combining logical connectives.
...
\begin{problem}[DeMorgan's Law]\label{prob:demorgan}
