...
\begin{problem}
Let $x$ be an integer.  Prove or provide a counterexample: If 6 divides $x$, then 3 divides $x$.\end{problem}

\begin{problem}
Let $x$ be an integer.  Prove or provide a counterexample: If 6 divides $x$, then 4 divides $x$
\end{problem}

\begin{theorem}[*]
For all integers $n$, $x$ and $y$, if $n$ divides $x$ and $n$ divides $y$, then $n$ divides $x+y$
\end{theorem}
...
Prove each of the next two propositions using the contrapositive of the given statement.
...
\begin{theorem}
For all integers $n$, $x$, and $y$, if $n|x$, then $n|(xy)$.
\end{theorem}
