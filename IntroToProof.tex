...
\item Appendix~\ref{appendix:elements_of_style}: The Elements of Style for Proofs is a blending of work by Anders Hendrickson and Dave Richeson.
\item Dave Richeson is the original author of Appendix~\ref{appendix:fancy_math_terms}: Fancy Mathematical Terms and Appendix~\ref{appendix:definitions}: Definitions in Mathematics.
\end{itemize}
