...
Recall that we use the symbol ``$\in$" as an abbreviation for the phrase ``is an element of".  For example, the mathematical expression ``$n\in\mathbb{Z}$" means ``$n$ is an element of the integers."
