...
\begin{theorem}[*]
Assume $a$, $m$, and $n$ are integers. Suppose $a$ divides $m$ and $a$ divides $n$.  Then $a$ divides $m+n$. 
\end{theorem}

\begin{problem}[*]
Assume $a$, $b$, and $m$ are integers. Determine whether the following statement holds sometimes, always, or never.  If the number $ab$ divides $m$, then $a$ divides $m$ and $b$ divides $m$.
\end{problem}
