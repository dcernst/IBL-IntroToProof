...
\begin{theorem}[Principle of Mathematical Induction]\label{thm:generalPMI}
...
Theorem~\ref{thm:generalPMI} gives a process for proving statements of the form: ``For all integers $n\geq a$, $P(n)$.'' As before, hypothesis (i) is called the \textbf{base step}, and (ii) is called the \textbf{inductive step}.
