...
\begin{definition}
Two quantified propositions are \textbf{logically equivalent in a given universe of discourse} if and only if they have the same truth value in that universe.  Two quantified propositions are \textbf{logically equivalent} if and only if they are logically equivalent in every universe of discourse.
\end{definition}

\begin{problem}
Consider the propositions $(\exists x)(x^2-4=0)$ and $(\exists x)(x^2-2=0)$.  
\begin{enumerate}[label=\textrm{(\alph*)}]
\item Are these propositions logically equivalent if the universe of discourse is the set of real numbers?
